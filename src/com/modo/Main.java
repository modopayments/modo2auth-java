...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        if (HttpURLConnection.HTTP_OK == postResponse.statusCode()) {
            System.out.println("Successful request to URL: " + apiHostUrl);
            System.out.println(postResponse.body());
        } else if (HttpURLConnection.HTTP_UNAUTHORIZED == postResponse.statusCode()) {
            System.out.println("Unauthorized status code returned from server, please check your URL and credentials");
            return;
        } else {
            System.out.println("Unknown error returned from the server. Response Code: " + postResponse.statusCode());
            return;
        }
        ...
        if (HttpURLConnection.HTTP_OK == getResponse.statusCode()) {
            ...
            System.out.println("Unknown error returned from the server. Response Code: " + getResponse.statusCode());
            return;
        }
    }
